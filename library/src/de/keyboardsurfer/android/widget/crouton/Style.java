...
public class Style {
    ...
    /**
     * The text type face file name to be loaded from assets
     */
    final String textTypeFaceFileName;
    ...
    private Style(final Builder builder) {
        ...
        this.textTypeFaceFileName = builder.textTypeFaceFileName;
    ...
    public static class Builder {
        ...
        private String textTypeFaceFileName;
        ...
        /**
         * Set the font filename to be loaded as custom font
         *
         * @param textTypeFaceFileName
         */
        public void setTextTypeFaceFileName(String textTypeFaceFileName) {
            this.textTypeFaceFileName = textTypeFaceFileName;
        }
