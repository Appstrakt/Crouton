 ...
 * <p/>
 * <b>Important: </b> Call {@link Crouton#clearCroutonsForActivity(Activity)} within {@link android.app.Activity#onDestroy()} to avoid {@link Context} leaks.
 */
public final class Crouton {
	 ...
	 *            The configuration for this Crouton.
	 */
	public static void showText(Activity activity, CharSequence text, Style style, int viewGroupResId, final Configuration configuration) {
	...
	/**
	 * Cancels all queued {@link Crouton}s. If there is a {@link Crouton} displayed currently, it will be the last one displayed.
	 */
	...
	/**
	 * Displays the {@link Crouton}. If there's another {@link Crouton} visible at the time, this {@link Crouton} will be displayed afterwards.
	 */
	public void show() {
	...
	public String toString() {
		return "Crouton{" + "text=" + text + ", style=" + style + ", configuration=" + configuration + ", customView=" + customView + ", onClickListener=" + onClickListener + ", activity=" + activity + ", viewGroup=" + viewGroup + ", croutonView=" + croutonView + ", inAnimation=" + inAnimation + ", outAnimation=" + outAnimation + ", lifecycleCallback=" + lifecycleCallback + '}';
	}
